...
## Project Structure
    ...
    ├── testapiautodatamod_113974  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_113974`
...
2. Clone this repo and `cd testapiautodatamod_113974`
